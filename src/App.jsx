...
import "./App.css";
import  icon from "./assets/icons8-alert-50.png"
            ...
            <div>
              ...
              <div className="input-container">
                <div className="input-group">
                  ...
                  />
                  {errors.bvn && (
                    <span className="error-message">{errors.bvn}</span>
                  )}
                </div>
                ...
                <div className="input-group">
                  ...
                  />
                  {errors.nin && (
                    <span className="error-message">{errors.nin}</span>
                  )}
                </div>
              </div>
              <div className="alert">
                ...
                <div>
                  {" "}
                  <p>
                    Please ensure that you enter your correct BVN and NIN. These
                    will be used to verify your identity and cannot be changed
                    later.
                  </p>
                </div>
              </div>
