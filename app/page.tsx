      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-2xl">
        ...
        <div className="flex justify-between mb-8 text-center text-sm font-medium">
          {[
            ...
            <div key={step} className="flex-1">
              ...
              <div className={index === 0 ? "text-black" : "text-gray-500"}>
                {step}
              </div>
            </div>
          ))}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-yellow-100 text-yellow-800 text-sm p-3 rounded border border-yellow-300">
            <strong>Important:</strong> Please ensure that you enter your
            correct BVN and NIN. These will be used to verify your identity and
